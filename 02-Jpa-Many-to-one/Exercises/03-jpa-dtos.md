...
**Prerequisites:** You should have completed Exercise 02 (Bidirectional Relationships) with Customer and Order entities using `@JsonManagedReference` and `@JsonBackReference`.
